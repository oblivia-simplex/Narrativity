...
\hypersetup{
  pdftitle={Narrativity},
  pdfauthor={Mary Burger, Robert Glück, Camille Roy, and Gail Scott},
  hidelinks,
...
\usepackage{Zallman}
\newcommand*\capfont{\usefont{U}{Zallman}{xl}{n}}
...
\addcontentsline{toc}{section}{Issue One}

\hypertarget{kathy-acker}{%
\paragraph{Kathy Acker}\label{kathy-acker}}
\addcontentsline{toc}{paragraph}{Kathy Acker}
...
\addcontentsline{toc}{paragraph}{Lawrence Ytzhak Brathwaite}
...
\addcontentsline{toc}{paragraph}{Mary Burger}
...
\addcontentsline{toc}{paragraph}{David Buuck}
...
\addcontentsline{toc}{paragraph}{Jacques Debrot}
...
\addcontentsline{toc}{paragraph}{Jeff Derksen}
...
\addcontentsline{toc}{paragraph}{Robert Glück}
...
\addcontentsline{toc}{paragraph}{Rob Halpern's}
...
\addcontentsline{toc}{paragraph}{Laird Hunt}
...
\addcontentsline{toc}{paragraph}{Trevor Joyce}
...
\addcontentsline{toc}{paragraph}{Kevin Killian}
...
\addcontentsline{toc}{paragraph}{Chris Kraus}
...
\addcontentsline{toc}{paragraph}{Rachel Levitsky}
...
\addcontentsline{toc}{paragraph}{Pamela Lu}
...
\addcontentsline{toc}{paragraph}{Ashok Mathur}
...
\addcontentsline{toc}{paragraph}{Laura Moriarty's}
...
\addcontentsline{toc}{paragraph}{Nicole Markotic}
...
\addcontentsline{toc}{paragraph}{Lisa Robertson}
...
\addcontentsline{toc}{paragraph}{Camille Roy}
...
\addcontentsline{toc}{paragraph}{Leslie Scalapino's}
...
\addcontentsline{toc}{paragraph}{Gail Scott's}
...
\addcontentsline{toc}{paragraph}{Juliana Spahr's}
...
\addcontentsline{toc}{paragraph}{Anne Stone}
...
\addcontentsline{toc}{paragraph}{Michelle Tea}
...
\addcontentsline{toc}{section}{Issue Two}

\hypertarget{mike-amnasan}{%
\paragraph{Mike Amnasan}\label{mike-amnasan}}
\addcontentsline{toc}{paragraph}{Mike Amnasan}
...
\addcontentsline{toc}{paragraph}{Betsy Andrews}
...
\addcontentsline{toc}{paragraph}{Taylor Brady}
...
\addcontentsline{toc}{paragraph}{Nicole Brossard}
...
\addcontentsline{toc}{paragraph}{Brenda Coultas}
...
\addcontentsline{toc}{paragraph}{Margaret Christakos}
...
\addcontentsline{toc}{paragraph}{Aja Couchois Duncan}
...
\addcontentsline{toc}{paragraph}{Corey Frost}
...
\addcontentsline{toc}{paragraph}{Susan Gevirtz's}
...
\addcontentsline{toc}{paragraph}{Renee Gladman}
...
\addcontentsline{toc}{paragraph}{Gad Hollander:}
...
\addcontentsline{toc}{paragraph}{Eileen Myles}
...
\addcontentsline{toc}{paragraph}{Daniel M. Nester's}
...
\addcontentsline{toc}{paragraph}{Doug Rice}
...
\addcontentsline{toc}{paragraph}{Elizabeth Robinson's}
...
\addcontentsline{toc}{paragraph}{Jono Schneider}
...
\addcontentsline{toc}{paragraph}{Kathy Lou Schultz}
...
\addcontentsline{toc}{paragraph}{Aaron Shurin's}
...
\addcontentsline{toc}{paragraph}{Brian Strang}
...
\addcontentsline{toc}{paragraph}{Lawrence Upton's}
...
\addcontentsline{toc}{section}{Quotes from Bob Glück}

\hypertarget{from-antonin-artaud-anthology-ed.-jack-hirschman}{%
\subsection*{\texorpdfstring{From \emph{Antonin Artaud Anthology},
ed.~Jack
Hirschman}{From Antonin Artaud Anthology, ed.~Jack Hirschman}}\label{from-antonin-artaud-anthology-ed.-jack-hirschman}}
\addcontentsline{toc}{subsection}{From \emph{Antonin Artaud Anthology},
ed.~Jack Hirschman}
...
\addcontentsline{toc}{subsection}{From \emph{The Gospel According to
Thomas}}
...
\addcontentsline{toc}{subsection}{From \emph{Foucault/Blanchot, Maurice
Blanchot}: "The Thought from the Outside" by Michel Foucault}
...
\addcontentsline{toc}{subsection}{From \textsc{The Madness of the Day},
by Maurice Blanchot, trans. Lydia Davis}
...
\addcontentsline{toc}{subsection}{From "Crossing into Poland" by Isaac
Babel trans. Walter Morison, \textsc{The Collected Stories}.}
...
\addcontentsline{toc}{section}{Quotes from Camille Roy}
...
\addcontentsline{toc}{subsection}{Excerpts from "The Storyteller," by
Walter Benjamin}
...
\addcontentsline{toc}{section}{Excerpts from "Fame," by Robert Gluck}
...
\addcontentsline{toc}{section}{Excerpts from "Paragraphs Blowing On A
Line," by Gail Scott}

\hypertarget{entry-11}{%
\subsection*{Entry 11:}\label{entry-11}}
\addcontentsline{toc}{subsection}{Entry 11:}
...
\addcontentsline{toc}{subsection}{Entry 25}
...
\addcontentsline{toc}{section}{Excerpts from "Interview with Carla
Harryman," by Chris Tysh}
...
\addcontentsline{toc}{section}{Quotes from Gail Scott}
...
\addcontentsline{toc}{subsection}{From \emph{Eros The Bittersweet}, by
Anne Carson}
...
\addcontentsline{toc}{subsection}{From \emph{The Shell and the Kernel}
(Vol. 1) by Nicholas Abraham and Maria Torok}
...
\addcontentsline{toc}{subsection}{From \emph{Zoo or Letters Not About
Love} by Viktor Shklovsky}
...
\addcontentsline{toc}{subsection}{From Lyn Hejinian's Introduction to
Jena Osman's \emph{Character}}
...
\addcontentsline{toc}{subsection}{From "Not All Halfbreed Mothers" in
\emph{I Knew Two Métis Women}, by Greg Scofield}
...
\addcontentsline{toc}{section}{Quotes from Mary Burger}
...
\addcontentsline{toc}{subsection}{From \emph{Tristram Shandy}, by
Laurence Sterne, first published 1760}

\hypertarget{chapter-v}{%
\subsubsection*{Chapter V}\label{chapter-v}}
\addcontentsline{toc}{subsubsection}{Chapter V}
...
\addcontentsline{toc}{subsubsection}{Chapter VI}
...
\addcontentsline{toc}{subsection}{From \emph{The Confessions of Saint
Augustine}, Trans Edward B. Pusey, D.D. First published c.~400 A.D.}
...
\addcontentsline{toc}{subsection}{From \emph{Our Lady of the Flowers},
...
\addcontentsline{toc}{subsection}{From, \emph{Spacetime, Geometry,
Cosmology}, William L. Burke, University Science Books, Mill Valley,
1980.}
...
\addcontentsline{toc}{subsection}{From \emph{The Passion}, Jeanette
Winterson, Vintage Books, 1989}
...
\addcontentsline{toc}{section}{I. Poetically}
...
\addcontentsline{toc}{subsection}{To I this plot}
...
\addcontentsline{toc}{subsection}{A crisis of audience}
...
\addcontentsline{toc}{subsection}{Intentional fallacies}
...
\addcontentsline{toc}{subsection}{``Something more''}
...
\addcontentsline{toc}{section}{II. Politically}
...
\addcontentsline{toc}{section}{Narrative difference}
...
\addcontentsline{toc}{section}{Critical faith}
...
\addcontentsline{toc}{section}{A. Alphabets}
...
\addcontentsline{toc}{section}{B. Bully}
...
\addcontentsline{toc}{section}{C. Cut me ups}
...
\addcontentsline{toc}{section}{Bottom Notes}
...
\addcontentsline{toc}{section}{The Ensemble Exists}
...
\addcontentsline{toc}{section}{The Onset Exits and the Damage Done}
...
\addcontentsline{toc}{section}{From \emph{Charisma}}

\hypertarget{working-notes-1}{%
\subsection*{Working Notes}\label{working-notes-1}}
\addcontentsline{toc}{subsection}{Working Notes}
...
\addcontentsline{toc}{subsection}{CAMEO}
...
\addcontentsline{toc}{subsection}{MARILYN}
...
\addcontentsline{toc}{section}{Notes on Narrativity - Writing in Prose}
...
\addcontentsline{toc}{section}{Etymology's Nemesis}
...
\addcontentsline{toc}{section}{In this place which Legend Posits}
...
\addcontentsline{toc}{section}{Paper Doll Day}
...
\addcontentsline{toc}{section}{Renee Gladman: From \emph{Studies}}
...
\addcontentsline{toc}{subsection}{``the natural suspicion of words''}
...
\addcontentsline{toc}{section}{God Save My Queen (The Freddie
Fragments)}
...
\addcontentsline{toc}{section}{\emph{Prophet's Song}}
...
\addcontentsline{toc}{section}{Denial}
...
\addcontentsline{toc}{subsection}{WRITING THE TELLING'S WANTING}
...
\addcontentsline{toc}{section}{"Both And": A Statement for Narrativity}
...
\addcontentsline{toc}{section}{5. Adjustable Perches}
...
\addcontentsline{toc}{section}{7. Bait and Switch}
...
\addcontentsline{toc}{section}{8. Epilogue}
...
\addcontentsline{toc}{section}{On Narrative}

\hypertarget{am}{%
\subsection*{3:28am}\label{am}}
\addcontentsline{toc}{subsection}{3:28am}
...
\addcontentsline{toc}{section}{2:48am}
...
\addcontentsline{toc}{section}{2:49am}
...
\addcontentsline{toc}{section}{4:58am}
...
\addcontentsline{toc}{section}{4:59am}
...
\addcontentsline{toc}{section}{3:29am}
...
\addcontentsline{toc}{section}{5:13am}
...
\addcontentsline{toc}{section}{2:16am}
...
\addcontentsline{toc}{section}{4:22pm}
...
\addcontentsline{toc}{section}{6:12am}
...
\addcontentsline{toc}{section}{2:59pm}
...
\addcontentsline{toc}{section}{5:55am}
...
\addcontentsline{toc}{section}{2:12am}
...
\addcontentsline{toc}{subsection}{Concern}
